 ...
 * Simple client class.  This class connects to an DDSproject.EchoServer to send
 * text back and forth.  Java message serialization is used to pass
 * DDSproject.Message objects around.
 *
 */
public class EchoClient
{
    /**
     * Loan.DDSproject.Main method.
	...
	if(args.length != 2)
        {
            ...
            System.err.println("Usage:  java DDSproject.EchoClient <Server name or IP> <Server Port Number\n");
            System.exit(-1);
        }
...
} //-- end class DDSproject.EchoClient